...
def generar_pdf(partidos, n_gallos):
    ...
    for r in range(1, n_gallos + 1):
        ...
        t.setStyle(TableStyle([('BACKGROUND', (0,0), (-1,0), colors.HexColor("#1a1a1a")), ('TEXTCOLOR', (0,0), (-1,0), colors.HexColor("#E67E22")),
                               ('ALIGN', (0,0), (-1,-1), 'CENTER'), ('FONTNAME', (0,0), (-1,0), 'Helvetica-Bold'), ('FONTSIZE', (0,0), (-1,-1), 8),
                               ('GRID', (0,0), (-1,-1), 0.5, colors.grey), ('VALIGN', (0,0), (-1,-1), 'MIDDLE'), ('LINEBEFORE', (2,1), (2,-1), 2, colors.red),
                               ('LINEAFTER', (7,1), (7,-1), 2, colors.green), ('BACKGROUND', (1,1), (1,-1), colors.whitesmoke)]))
    ...
    elements.append(Paragraph("<font color='grey' size=8>SISTEMA DE GESTIÓN DIGITAL - DerbySystem v2.0</font>", styles['Normal']))
    doc.build(elements)
...
with t_cot:
    if len(st.session_state.partidos) >= 2:
        try:
            ...
            st.download_button(label="📥 GENERAR REPORTE OFICIAL (PDF)", data=pdf_bytes, file_name=f"cotejo_{st.session_state.id_usuario}.pdf", mime="application/pdf", use_container_width=True, type="primary")
