...
# --- ESTILOS ORIGINALES (PROHIBIDO TOCAR) ---
st.markdown("""
    <style>
    .caja-anillo {
...
with t_list[0]:
    ...
    with st.form("f_nuevo", clear_on_submit=True):
        ...
        for i in range(g_sel):
            ...
            # Anillo automático sin ceros conflictivos en el código
            st.markdown(f"<div class='caja-anillo'>ANILLO: {anillos_actuales + i + 1:03d}</div>", unsafe_allow_html=True) [cite: 14-01-2026]
            st.write("") 
    ...
    if st.session_state.partidos:
        ...
        # BOTÓN DE BORRAR VISIBLE PARA TODOS
