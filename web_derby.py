...
# --- DISEÑO (CSS SEGURO PARA MÓVIL Y PC) ---
st.markdown("""
    <style>
    ...
    /* BLOQUE VERTICAL PARA PESO Y ANILLO */
    .bloque-datos {
        display: flex;
    ...
    .dif-alerta { background-color: #e74c3c; color: white; font-weight: bold; padding: 2px 6px; border-radius: 3px; }
...
with t_reg:
    ...
    g_sel = col_g.selectbox("GALLOS:", [2, 3, 4, 5, 6], index=st.session_state.n_gallos-2 if st.session_state.n_gallos <= 6 else 0, disabled=hay_datos)
    ...
    if len(st.session_state.partidos) >= 2:
        ...
        for r in range(1, st.session_state.n_gallos + 1):
            ...
            html = """<table class='tabla-final'>
                <tr>
                    <th>#</th><th>G</th><th>LADO ROJO</th><th>DIF</th><th>E</th><th>LADO VERDE</th><th>G</th>
                </tr>"""
